                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="POST" id="page11" name="page11" action="<?php echo site_url('Inbox_controller/Feedback');?>">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label></label>
                                                <textarea name="feed" id="feed" rows="5" class="form-control" placeholder="Here can be your description"><?php //echo $about;?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <label></label>
                                            <textarea name="feed" id="feed" rows="3" class="form-control" placeholder="Here can be your description"><?php echo $item->Comment;?></textarea>
                                        <?php  }
                                        ?>
                                        </div>
                                    </div>
