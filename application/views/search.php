...
<?php
    ...
    {
        $age_from_ = $search_data->Age_from;
        $age_to_ = $search_data->Age_to;
        $height_from_ = $search_data->Height_from;
        $height_to_ = $search_data->Height_To;
        $gender_ = $search_data->Gender;
        $looking_for_ = $search_data->Looking_For;
        $martial_status_ = $search_data->Martial_Status;
        $religion_ = $search_data->Religion;
        $tongues_ = $search_data->Mother_Tongue;
       // $community_ = $search_data=->Community;
        $country = $search_data->Country;
        $state_ = $search_data->State;
    }  
    else 
    {
      $age_from_  = '';
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="State" value="<?php echo $state_;?>">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header">
                                ...
                                <img height="100%" width="100%" src="<?php echo base_url(),"Matrimonial/";?>images/tu-hoang-746434-unsplash.jpg"><br>
                            </div>
