	...
	<div class="main-bg">
		...
		<div class="sub-main-w3">
			<div class="bg-content-w3pvt">
				...
				<form method="post" id="login" name="login" action="<?php echo site_url('Page_login_controller/authenticate');?>">
				...
				<a href="<?php echo site_url('forgot_password_controller/index');?>" class="bottom-text-w3ls">Forgot Password?</a>
				<br>
