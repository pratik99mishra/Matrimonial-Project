        ...
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" id="page1" name="page1" action="<?php echo site_url('Page_1_controller/register');?>">
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="Username" id="txtName" name="txtName">
                        </div>
                        <div class="input-group">
                            <input class="input--style-2" type="email" placeholder="Email" id="txtEmail" name="txtEmail">
                        </div>
                        <div class="input-group">
                            <input class="input--style-2" type="password" placeholder="Password" id="txtPwd" name="txtPwd">
                        </div>
                    ...
                    <a href="<?php echo site_url('Index1_controller/index');?>">
                        <label style="margin-left: 100%;">Home</label>
                    </a>
                </div>
            </div>
        </div>
