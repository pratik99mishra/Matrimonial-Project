...
<head>
    ...
    <!-- Main CSS-->
    <link href="<?php echo base_url(),"Matrimonial/";?>css/Registration-Page-3.css" rel="stylesheet" media="all">
        ...
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" id="page3" name="page3" action="<?php echo site_url('Page_3_controller/personal_info');?>">
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder=" Father's Name" name="name" id="name">
                        </div>
                        <div class="input-group">
                                ...
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="Country" id="Country">
                                            ...
                                            <option value="India" selected="sel"><b>India</b></option>
                                ...
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="txtState" id="txtState">
                                            ...
                                            <option value="Never Married" label="Never Married">Bihar</option>
                                            <option value="Divorced" label="Divorced">Uttrakhand</option>
                                        </select>
                                        <div class="select-dropdown"></div>
                                    </div>
                                </div>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <input class="input--style-2" type="text" placeholder="Gothram/Gothra" name="Gothram" id="Gothram">   
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-2" type="text" placeholder="Nakshtra" name="nakshtra" id="nakshtra">
                                </div>
                            </div>
                        </div>
                        <div class="p-t-30">
